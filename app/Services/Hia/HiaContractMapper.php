        ...
        return [
           ...
           */
            ...
            */
            ...
            |--------------------------------------------------------------------------
            */
            'special_conditions' => 'IF ANY STAGE OF THE PROJECT CANNOT BE TOTALLY COMPLETED DUE TO CIRCUMSTANCES BEYOND THE CONTROL OF THE BUILDER AND WORK IS BEING CARRIED OUT ON SUBSEQUENT STAGE(S), THEN THAT PROGRESS PAYMENT SHALL BE MADE ON A "COST TO COMPLETE" BASIS.
 
TO ENSURE EFFECTIVE COMMUNICATION AND SITE MANAGEMENT OF YOUR PROJECT, YOU AGREE THAT ALL PROJECT-RELATED COMMUNICATION FROM YOURSELF AS THE CLIENT, MUST ALWAYS BE DIRECTED EXCLUSIVELY TO YOUR SITE SUPERVISOR FOR THE DURATION OF THE BUILDING PERIOD. THIS PROVIDES A CLEAR POINT OF CONTACT FOR ALL COMMUNICATION TO ENSURE ACCOUNTABITY, AS THE SITE SUPERVISOR IS THE ONLY PERSON FULLY BRIEFED ON ALL ASPECTS OF THE PROJECT AND IS BEST POSITIONED TO ADDRESS ANY QUERIES AND AUTHORISE ANY CHANGES TO THE CONTRACTED WORKS AND AS SUCH NO DIRECT COMMUNICATION BY YOU AS THE CLIENT WITH THE TRADES IS PERMITTED UNDER ANY CIRCUMSTANCES.   
 
ONCE YOUR PROJECT STARTS CONSTRUCTION IT IS DEEMED A ‘CONSTRUCTION SITE’ AND AS SUCH SITE SAFETY & ACCESS MUST BE ADHERED TO AT ALL TIMES EVEN IF YOU ARE TO REMAIN IN OCCUPATION IN PART OF THE HOUSE DURING THE BUILDING WORKS. TO ENSURE THIS IS UPHELD AT ALL TIMES WHILE YOUR PROJECT IS IN CONSTRUCTION, YOU AGREE TO ADHERE TO ALL SAFETY PROTOCOLS OF THE SITE AS LAID OUT BY YOUR SITE SUPERVISOR AND ARE AT NO TIME ALLOWED TO ACCESS THE BUILDING WORKS WITHOUT YOUR SITE SUPERVISOR PRESENT EVEN OUTSIDE OF SITE WORK HOURS.
 
ANY CONSTRUCTION, ALTERATIONS, OR MODIFICATIONS CARRIED OUT BY YOU OR ANY THIRD-PARTY CONTRACTORS NOT ENGAGED OR APPROVED BY CAPE COD AUSTRALIA PTY LTD ARE NOT COVERED UNDER OUR STRUCTURAL WARRANTY OR ANY OTHER WARRANTY/GUARANTEES PROVIDED BY US. THIS INCLUDES, BUT IS NOT LIMITED TO, CHANGES TO THE DESIGN, ADDITIONAL STRUCTURES, ALTERATIONS, OR ANY OTHER MODIFICATIONS. A DETAILED DESCRIPTION OF THE PROPOSED WORK, INCLUDING PLANS, SPECIFICATIONS, AND THE CONTACT DETAILS OF ANY THIRD-PARTY CONTRACTORS IS REQUIRED AND SHOULD BE SUBMITTED TO YOUR ALLOCATED SITE SUPERVISOR PRIOR TO THE COMMENCEMENT OF SAID WORKS. NO ADDITIONAL WORKS SHOULD COMMENCE UNTIL WRITTEN APPROVAL IS GRANTED BY OUR MANAGING DIRECTOR. THIS IS TO PROTECT THE INTEGRITY OF THE BUILDING APPROVALS, CERTIFICATION AND CONSTRUCTION PROCESS AND ENSURE THAT ALL PARTIES ARE ALIGNED.',
        ];
    }
