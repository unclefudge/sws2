...
class MaintenanceSupervisorNoActionReport implements ScheduledOperationHandler
{
    ...
    public static function scheduledOperation(): array
    {
        return [
            ...
            'dynamicRecipients' => [
                ['key' => 'site_supervisor', 'label' => 'Maintenance Supervisor', 'delivery' => 'to', 'description' => 'The Supervisor assigned to the maintenance requests in the individual email.', 'required' => true],
            ],
    ...
    public function handle(): int
    {
        ...
        foreach ($groups as $group) {
            ...
            $dynamicRecipients = $this->recipientResolver->user('site_supervisor', 'Maintenance Supervisor', $group['supervisor'], 'to');
