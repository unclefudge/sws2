...
class SiteMaintenanceExecutive extends Mailable implements ShouldQueue {
    ...
    public function build()
    {
        ...
        return $this->markdown('emails/site/maintenance-executive')->subject('SafeWorksite - Site Maintenance Executive Report');
    }
}
