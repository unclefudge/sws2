...
class CronReportController extends Controller
{
    ...
    static public function nightly()
    {
        ...
        if (Carbon::today()->isMonday()) {
            \App\Http\Controllers\Misc\CronReportController::emailJobstart();
            \App\Http\Controllers\Misc\CronReportController::emailMaintenanceAppointment();
            \App\Http\Controllers\Misc\CronReportController::emailMaintenanceUnderReview();
            //CronReportController::emailMaintenanceOnHold();
            //CronReportController::emailMissingCompanyInfo();
            \App\Http\Controllers\Misc\CronReportController::emailMissingCompanyInfoPlanner();
            \App\Http\Controllers\Misc\CronReportController::emailCompanyDocsPending();
            \App\Http\Controllers\Misc\CronReportController::emailActiveAsbestos();
            \App\Http\Controllers\Misc\CronReportController::emailSupervisorAttendance();
            \App\Http\Controllers\Misc\CronReportController::emailScaffoldOverdue();
            \App\Http\Controllers\Misc\CronReportController::emailOutstandingOnHoldQA();
            \App\Http\Controllers\Misc\CronReportController::emailEquipmentTransfers();
            \App\Http\Controllers\Misc\CronReportController::emailProjectSupplyOverdue();
            \App\Http\Controllers\Misc\CronReportController::emailPendingElectricalPlumbing();
        }

        if (Carbon::today()->isTuesday()) {
            \App\Http\Controllers\Misc\CronReportController::emailUpcomingJobCompilance();
            \App\Http\Controllers\Misc\CronReportController::emailMaintenanceSupervisorNoAction();
            \App\Http\Controllers\Misc\CronReportController::emailPracCompletionSupervisorNoAction();
        }
        ...
        if (Carbon::today()->isThursday()) {
            ...
            \App\Http\Controllers\Misc\CronReportController::emailActiveElectricalPlumbing();
        }

        if (Carbon::today()->isFriday()) {
            \App\Http\Controllers\Misc\CronReportController::emailEquipmentRestock();
        }
        ...
        if (Carbon::today()->isMonday() && $start_monday->diffInDays(Carbon::now()) % 2 == 0)
            \App\Http\Controllers\Misc\CronReportController::emailFortnightlyReports();

        // Monthly first Tuesday of the month
        $first_tues = new Carbon('first tuesday of this month');
        if (Carbon::today()->isSameDay($first_tues)) {
            \App\Http\Controllers\Misc\CronReportController::emailOldUsers();
        }

        // Monthly last Friday of the month
        $last_fri = new Carbon('last friday of this month');
        if (Carbon::today()->isSameDay($last_fri)) {
            \App\Http\Controllers\Misc\CronReportController::emailOutstandingAftercare();
        }

        // Monthly Reports
        if (Carbon::today()->format('d') == '01') {
            \App\Http\Controllers\Misc\CronReportController::emailTradesAttendance();
        }
        ...
        if (Carbon::today()->format('d') == '01' && in_array(Carbon::today()->format('m'), $quarterly_months)) {
            \App\Http\Controllers\Misc\CronReportController::emailMaintenanceExecutive();
        }
