    ...
    static public function emailUpcomingJobs()
    {
        ...
        if (app()->environment('prod')) {
            if ($today->isMonday()) {
                ...
                $email_cc = ['clinton@capecod.com.au', 'scott@capecod.com.au'];
                $email_subject = "Upcoming Jobs Compliance - Pre Planning Meeting " . $today->format('d.m.y');
            }
            if ($today->isThursday()) {
                $email_to = ['alethea@capecod.com.au', 'keith@capecod.com.au', 'kirstie@capecod.com.au', 'nadia@capecod.com.au', 'ross@capecod.com.au'];
                $email_cc = ['clinton@capecod.com.au', 'scott@capecod.com.au', 'michelle@capecod.com.au', 'jayden@capecod.com.au'];
