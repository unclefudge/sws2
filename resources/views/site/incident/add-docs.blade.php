                    ...
                    <div class="portlet-body form">
                        <div class="page-content-inner">
                            ...
                            <div id="multifile-div">
                                ...
                                @if(Auth::user()->allowed2('add.site.incident'))
                                    <div class="note note-warning">
                                        ...
                                        Once you have selected your files upload them by clicking <button class="btn dark btn-outline btn-xs" href="javascript:;"><i class="fa fa-upload"></i> Upload</button> then once finalised click <button class="btn dark btn-outline btn-xs" href="javascript:;">Complete</button>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <div class="pull-right" style="min-height: 50px">
                                ...
                                <a href="/site/incident/{{ $incident->id }}" class="btn green"> Complete</a>
                            </div>
                            <br><br>
                            {!! Form::close() !!}
                        </div>
