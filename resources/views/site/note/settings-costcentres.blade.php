                    ...
                    <div class="portlet-body form">
                        ...
                        <div class="form-body">
                            <ul class="nav nav-tabs ">
                                <li class="">
                                    <a href="/site/note/settings"> Categories </a>
                                </li>
                                <li class="active">
                                    <a> Cost Centres </a>
                                </li>
                            ...
                            <h3> Cost Centres<span class="pull-right"><small><button class="btn btn-circle btn-outline btn-sm blue btn-add-item" id="btn-add-item">Add option</button></small></span></h3>
