...
.sws-modal-backdrop {
            ...
            /* Bootstrap/jQuery modal driver using the same SWS modal design */
            .sws-bootstrap-modal {
            ...
            .sws-bootstrap-modal.in {
                display: flex !important;
                align-items: center;
                justify-content: center;
            }

            .sws-bootstrap-modal .modal-dialog {
                width: 100%;
                margin: auto;
            }

            .sws-bootstrap-modal .sws-modal-card {
                margin: 0;
            }

            .sws-bootstrap-modal .sws-modal-body {
