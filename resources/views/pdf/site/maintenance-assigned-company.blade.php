...
<head>
    <meta charset="UTF-8">
    <title>Maintenance Assigned Company</title>
...
<div class="container">
    <div class="page22">
        ...
        @if ($mains->count())
            @foreach ($mains as $main)
                @if ($row_count == 0)
                    ...
                    <div class="row">
                        <div class="col-xs-9"><h3 style="margin: 0px">Maintenance Assigned Company</h3></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-2">Assigned Company</div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-2">{{ ($main->taskOwner) ? $main->taskOwner->name  : '-'}}</div>
                    <div class="col-xs-2">{{ ($main->assignedTo) ? $main->assignedTo->name  : '-'}}</div>
        ...
        @else
            ...
            <div class="row">
                <div class="col-xs-9"><br><br> There are currently no Maintenance Requests matching criteria</div>
            </div>
