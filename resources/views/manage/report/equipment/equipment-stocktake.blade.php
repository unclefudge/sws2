                    ...
                    <div class="portlet-body form">
                        <div class="note" style="background-color: #e1e5ec; border-color: #acb5c3">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <x-form.select name="completed" label="Stocktake was peformed between given dates" :options="['1' => 'Yes', '0' => 'No ']" value="1"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="portlet-body">
                            ...
                            <div id="stocktake-not">
                                <table class="table table-striped table-bordered table-hover order-column" id="table2">
                                    ...
                                    <tr class="mytable-header">
                                        <th style="width:5%"> #</th>
                                        <th style="width:95%"> Locations where stocktake hasn't been performed</th>
                                    </tr>
                                    </thead>
                                </table>
                            </div>
