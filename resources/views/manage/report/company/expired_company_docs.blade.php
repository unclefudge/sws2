                        ...
                        <div class="portlet-body form">
                            <div class="note" style="background-color: #e1e5ec; border-color: #acb5c3">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <x-form.select name="company_id" label="Company" :options="Auth::user()->company->companiesSelect('ALL')" plugin="select2"/>
                                    </div>
                                    <div class="col-md-4">
                                        <x-form.select name="compliance" label="Required for Compliance" :options="['' => 'Any', 'req' => 'Required for compliance', 'add' => 'Non-required documents']"/>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <x-form.select name="department" label="Department" :options="Auth::user()->companyDocDeptSelect('view', Auth::user()->company, 'all')"/>
                                    </div>
                                    <div class="col-md-4">
