...
@section('breadcrumbs')
    <ul class="page-breadcrumb breadcrumb">
        ...
        @endif
        <li><span>On Hold Quality Assurance</span></li>
    </ul>
@stop
...
@section('content')
    ...
    <div class="page-content-inner">
        <form method="POST" action="{{ action([\App\Http\Controllers\Misc\ReportController::class, 'OnholdQAPDF']) }}" class="horizontal-form">
            @csrf
            <div class="row">
                <div class="col-md-12">
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase font-green-haze"> On Hold Quality Assurance</span>
                            </div>
                            <div class="actions">
