            ...
            <div class="col-md-12">
                <div class="portlet light ">
                    ...
                    <div class="portlet-body">
                        <form method="POST" action="{{ action([\App\Http\Controllers\Misc\ReportController::class, 'maintenanceExecutive']) }}">
                            @csrf
                            @include('form-error')
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="date_from" class="control-label">Date range</label>
                                        <div class="input-group date date-picker input-daterange" data-date-format="dd/mm/yyyy">
                                            <input type="text" name="date_from" id="date_from" class="form-control" value="{{ old('date_from', $from->format('d/m/Y')) }}" readonly style="background:#FFF">
                                            <span class="input-group-addon"> to </span>
                                            <input type="text" name="date_to" id="date_to" class="form-control" value="{{ old('date_to', $to->format('d/m/Y')) }}" readonly style="background:#FFF">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <x-form.select name="categories[]" id="categories" label="Categories" :options="['all' => 'All'] + (\App\Models\Site\SiteMaintenanceCategory::all()->sortBy('name')->pluck('name', 'id')->toArray())" :value="$categories" plugin="select2" multiple
                                                   style="width:100%"/>
                                </div>
                                <div class="col-md-2">
                            ...
                            <table class="table table-striped table-bordered table-hover order-column" id="table_list">
                                ...
                                <tr class="mytable-header">
                                    ...
                                    <th style="width:10%">Allocated Date</th>
