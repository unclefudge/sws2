            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="portlet light ">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <x-form.select name="site_id" label="&nbsp;" :options="Auth::user()->company->sitesSelect('all')" :value="$site_id" plugin="select2"/>
                            </div>
                            <div class="col-md-2">
                                <x-form.select name="type" label="&nbsp;" :options="Auth::user()->companyDocTypeSelect('view', 'all')" :value="$type"/>
                            </div>
                        </div>
