            ...
            <div class="col-md-12">
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject font-green-haze bold uppercase">Add Designer Postcode</span>
                        </div>
                    </div>

                    <div class="portlet-body form">
                        <form method="POST" action="{{ action([App\Http\Controllers\Misc\DesignerPostcodeController::class, 'store']) }}">
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-3 pull-right">
                                        ...
                                        <div style="padding-top: 8px;">
                                            <x-form.checkbox2 name="active" checked :on-text="'Active'" :off-text="'Disabled'"/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <x-form.select name="council" label="Council" :options="['' => 'Select Council'] + $councils" plugin="select2" placeholder="Select Council"/>
                                    </div>
                                </div>
                            </div>
