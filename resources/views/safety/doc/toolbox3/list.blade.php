                ...
                <div class="portlet light ">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase font-green-haze"> Toolbox Talks (v3) Register</span>
                        </div>
                        <div class="actions">
                            @if(Auth::user()->hasPermission2('add.toolbox'))
                                <a class="btn btn-circle blue btn-sm" href="/safety/doc/toolbox3/create" data-original-title="Give a toolbox talk">Give a toolbox talk</a>
                            @endif
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            ...
                            @if(in_array(Auth::user()->id, [3, 108, 1155]))
                                <div class="actions">
                                    @if(Auth::user()->hasPermission2('add.toolbox'))
                                        <a class="btn btn-circle green btn-outline btn-sm" href="/safety/doc/toolbox3/create" data-original-title="Add">Add</a>
                                    @endif
...
@section('page-level-scripts')
    ...
    <script type="text/javascript">
        ...
        var table1 = $('#table1').DataTable({
            ...
            serverSide: true,
            ajax: {
                'url': '{!! url('safety/doc/dt/toolbox3') !!}',
                'type': 'GET',
                'data': function (d) {
                    d.status = $('#status').val();
                }
        ...
        var table2 = $('#table2').DataTable({
            ...
            serverSide: true,
            ajax: {
                'url': '{!! url('safety/doc/dt/toolbox3_templates') !!}',
                'type': 'GET',
                'data': function (d) {
