                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-green-haze bold uppercase">Edit Talk3</span>
...
@section('page-level-plugins-head')
    ...
    {{--}}<script src="https://cdn.tiny.cloud/1/hii43jh0384l2ju5a1xfvsnac6ysj8asoghjux0ogxhgm3uz/tinymce/7/tinymce.min.js" referrerpolicy="origin"></script>--}}
...
@section('page-level-scripts')
    ...
    <script type="module">
        ...
        const default_toolbar = ['undo', 'redo', '|', 'heading', '|', 'bold', 'italic', 'underline', '|', 'fontColor', 'fontBackgroundColor', '|',
            'bulletedList', 'numberedList', '|', 'outdent', 'indent', '|', 'horizontalLine', 'link', 'insertImage', 'mediaEmbed', 'insertTable'];
        const default_plugins = [Essentials, Bold, Italic, Font, Paragraph, Heading, HorizontalLine, List, Link, Underline, Indent, IndentBlock,
        ...
        ClassicEditor.create(document.querySelector('#ck_overview'), {
        ...
        ClassicEditor.create(document.querySelector('#ck_hazards'), {
            plugins: default_plugins,
            toolbar: default_toolbar,
        ...
        ClassicEditor.create(document.querySelector('#ck_controls'), {
            plugins: default_plugins,
            toolbar: default_toolbar,
        ...
        ClassicEditor.create(document.querySelector('#ck_further'), {
            plugins: default_plugins,
            toolbar: default_toolbar,
    ...
    <script>
        ...
        /* const overview = new Quill('#quill_overview', {
             theme: 'snow',
         });
         var tt = @json($talk->overview);
        alert(tt);

        overview.setText(@json($talk->overview));*/

        //overview.setText("start text");
        function initialiseContents() {
            //overview.setContents("start text\n");
        }
