                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                ...
                                @endif
                                <button class="btn btn-circle btn-icon-only btn-default grey-steel disabled  popovers" style="margin: 3px" data-container="body" data-trigger="hover" data-placement="top" data-content="Trade">T</button>
