                ...
                <div class="portlet light">
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            ...
                            @if ($canViewPreconstructionPlanner)<a href="{{ $this->plannerUrl('/planner/preconstruction', ['site_id' => null, 'trade_id' => null]) }}" class="btn btn-circle btn-icon-only btn-default popovers planner-toolbar-link" data-container="body" data-trigger="hover" data-placement="top" data-content="Pre-construction">P</a>@endif
