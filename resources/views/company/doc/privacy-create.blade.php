            ...
            <div class="col-md-12">
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">
                        <form method="POST" action="{{ action([App\Http\Controllers\Company\CompanyPrivacyPolicyController::class, 'store'], ['cid' => $company->id]) }}" class="horizontal-form">
                            @csrf
                            @include('form-error')
                                ...
                                <table class="table" style="padding: 0px; margin: 0px">
                                    <tr>
                                        ...
                                        <td class="pad5" style="border: 0px">
                                            ...
                                            This Privacy Policy is governed by the Australian Privacy Principles under the Privacy Act 1988. This Policy applies to the collection, storage, maintenance and disposal of personal information gathered from participants as part of the delivery of services
                                            to
                                            Cape Cod customers.
                                        </td>
                                    </tr>
                                ...
                                <table class="table" style="padding: 0px; margin: 0px">
                                    <tr>
                                        ...
                                        <td class="pad5" style="border: 0px">
                                            ...
                                            <p>Except as required by law, Cape Cod discloses personal information only for purposes that are reasonably related to Cape Cod’s Business and Association activities, and for which we have your actual consent or where you would reasonably expect Cape Cod
                                                to do
                                                so.</p>
