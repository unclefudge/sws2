            ...
            <div class="col-md-12">
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">
                        <form method="POST" action="{{ action([App\Http\Controllers\Company\CompanyPeriodTradeController::class, 'update'], ['cid' => $company->id, 'period_trade_contract' => $ptc->id]) }}" class="horizontal-form">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="form-body">
                                ...
                                conditions outlined herein as the <a href="{{ \Illuminate\Support\Facades\Storage::url('period_trade_contract_conditions.pdf') }}" target="_blank">Period Trade Contract Conditions</a>. By signing below each party acknowledges their full comprehension of the Period
                                Trade
                                ...
                                <div class="row">
                                    <div class="form-group {{ $errors->has('contractor_signed_name') ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-md-6">
                                            <x-form.textarea name="contractor_signed_name" :value="$ptc->contractor_signed_name" rows="3" disabled/>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <label for="principle_signed_name" class="col-md-3 control-label">Principle Contractor's Signature</label>
                                        <div class="col-md-6">
                                            @if (($ptc->principle_signed_id && $ptc->status != 2) || (Auth::user()->isCompany($ptc->company_id) && $ptc->status == 3 ))
                                                <x-form.textarea name="principle_signed_name" :value="$ptc->principle_signed_name" rows="3" readonly/>
            ...
            <div class="modal-content">
                <form action="#" method="POST" name="form_sign_contractor" id="form_sign_contractor">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <x-form.input name="signed_name" label="Enter your Name"/>
                            </div>
                        </div>
                        <br>
                    </div>
    ...
    <div id="modal_reject" class="modal fade" id="basic" tabindex="-1" role="modal_reject" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ action([App\Http\Controllers\Company\CompanyPeriodTradeController::class, 'reject'], ['cid' => $company->id, 'id' => $ptc->id]) }}" class="horizontal-form">
                        @csrf
                        <x-form.textarea name="reject" label="Reason for rejecting contract" :value="$ptc->reject" rows="3"/>
                </div>
                <div class="modal-footer">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="{{ action([App\Http\Controllers\Company\CompanyPeriodTradeController::class, 'update'], ['cid' => $company->id, 'period_trade_contract' => $ptc->id]) }}" class="horizontal-form">
                            @csrf
                            @method('PATCH')
                            <x-form.hidden name="archive" :value="$company->activeCompanyDoc('5')->id"/>
