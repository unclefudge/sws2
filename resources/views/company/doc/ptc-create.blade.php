                ...
                <div class="col-md-12">
                    <div class="portlet light bordered">
                        ...
                        <div class="portlet-body form">
                            <form method="POST" action="{{ action([App\Http\Controllers\Company\CompanyPeriodTradeController::class, 'store'], ['cid' => $company->id]) }}" class="horizontal-form">
                                @csrf
                                @include('form-error')
                                ...
                                <div class="form-body">
                                    ...
                                    <table class="table" style="padding: 0px; margin: 0px">
                                        ...
                                        <tr>
                                            <td class="pad0" style="width:5%; border: 0px"><h5 style="margin: 0px">&nbsp;</h5></td>
                                            <td class="pad5" style="border: 0px">
                                                ...
                                                <div style="width: 100%; display: table;">
                                                    ...
                                                    <span style="display: table-cell;">ACN @if ($company->reportsTo()->id == 3)
                                                            &nbsp; &nbsp; 000 605 407
                                                        @endif</span>
                                                </div>
                                                <div style="width: 100%; display: table;">
                                    ...
                                    <table class="table" style="padding: 0px; margin: 0px">
                                        <tr>
                                            <td style="width:5%; margin:5px 0 0 0; padding: 5px 0px; border: 0px"><h5 style="margin: 0px">3.</h5></td>
                                            <td class="pad5" style="border: 0px">
                                    ...
                                    <table class="table" style="padding: 0px; margin: 0px">
                                        <tr>
                                            <td style="width:5%; margin:5px 0px 0px 0px; padding: 5px 0px; border: 0px"><h5 style="margin: 0px">4.</h5></td>
                                            <td class="pad0" style="border: 0px;">
                                                ...
                                                the parties agree that the period trade contract conditions <a href="/period_trade_contract_conditions.pdf" target="_blank">here</a> are deemed to be incorporated into each <b>trade contract</b> for a period of 12 months from the date of this
                                                agreement.
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <table class="table" style="padding: 0px; margin: 0px">
                                        <tr>
                                            <td style="width:5%; margin:5px 0 0 0; padding: 5px 0px; border: 0px"><h5 style="margin: 0px">5.</h5></td>
                                            <td class="pad0" style="border: 0px">
                                    ...
                                    <table class="table" style="padding: 0px; margin: 0px">
                                        <tr>
                                            <td style="width:5%; margin:5px 0 0 0; padding: 5px 0px; border: 0px"><h5 style="margin: 0px">6.</h5></td>
                                            <td class="pad5" style="border: 0px">
                                    ...
                                    <table class="table" style="padding: 0px; margin: 0px">
                                        <tr>
                                            <td style="width:5%; margin:5px 0 0 0; padding: 5px 0px; border: 0px"><h5 style="margin: 0px">7.</h5></td>
                                            <td class="pad5" style="border: 0px">
                                    ...
                                    <table class="table" style="padding: 0px; margin: 0px">
                                        <tr>
                                            <td style="width:5%; margin:5px 0 0 0; padding: 5px 0px; border: 0px"><h5 style="margin: 0px">8.</h5></td>
                                            <td class="pad5" style="border: 0px">
                                    ...
                                    <table class="table" style="padding: 0px; margin: 0px">
                                        <tr>
                                            <td style="width:5%; margin:5px 0 0 0; padding: 5px 0px; border: 0px"><h5 style="margin: 0px">9.</h5></td>
                                            <td class="pad5" style="border: 0px">
                                    ...
                                    <br>This document serves as a formal agreement between the <b>Principal Contractor</b> and <b>Trade Contractor</b> as identified at 2 and 3 of the Schedule, hereby referred to as the 'parties,' representing their mutual understanding and acceptance of the terms
                                    and
                                    conditions outlined herein as the <a href="/period_trade_contract_conditions.pdf" target="_blank">Period Trade Contract Conditions</a>. By signing below each party acknowledges their full comprehension of the Period Trade Contract contents and willingly
                                    enters a legally binding contract.<br><br>
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6" style="display: none" id="contractor_signed_name_field">
                                                <x-form.textarea name="contractor_signed_name" rows="3" readonly/>
            ...
            <div class="modal-content">
                <form action="#" method="POST" name="form_sign_contractor" id="form_sign_contractor">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <x-form.input name="signed_name" label="Enter your Full Name"/>
                            </div>
                        </div>
                        <br>
                    </div>
