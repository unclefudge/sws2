                ...
                <div class="col-md-12">
                    <div class="portlet light bordered">
                        ...
                        <div class="portlet-body form">
                            <form method="POST" action="{{ action([App\Http\Controllers\Company\CompanySubcontractorStatementController::class, 'store'], ['cid' => $company->id]) }}" class="horizontal-form">
                                @csrf
                                @include('form-error')
                                ...
                                <div class="form-body">
                                    ...
                                    {{-- Note 3 --}}
                                    <div class="row">
                                        <div class="col-md-4"><label for="contract_no" class="control-label">Contract number/identifier</label></div>
                                        <div class="col-md-8">
                                            <x-form.input name="contract_no" placeholder="optional"/>
                                        </div>
                                    </div>
                                    ...
                                    {{-- Note 4 --}}
                                    <div class="row">
                                        <div class="col-md-4"><label for="contract_no" class="control-label">This Statement applies for work between:</label></div>
                                        <div class="col-md-2">
                                            <x-form.select name="date_from" :options="$dates_from" id="date_from"/>
                                        ...
                                        <div class="col-md-2">
                                            <x-form.select name="date_to" :options="$dates_to" id="date_to"/>
                                        </div>
                                        <div class="col-md-3">
                                    ...
                                    {{-- Note 5 --}}
                                    <div class="row">
                                        <div class="col-md-4"><label for="claim_payment" class="control-label">subject of the payment claim dated:</label></div>
                                        <div class="col-md-2">
                                            <div class="form-group {{ $errors->has('claim_payment') ? 'has-error' : '' }}">
                                                <x-form.datepicker name="claim_payment" readonly clear-button/>
                                                <!-- /input-group -->
                                                <x-form.error name="claim_payment"/>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <x-form.input name="contractor_full_name" id="contractor_full_name" placeholder="Full name"/>
                                        </div>
                                        <div class="col-md-5">
                                    ...
                                    <ol type="a" style="padding-left:15px">
                                        ...
                                        <li class="text-justify">The abovementioned Subcontractor has either employed or engaged workers or subcontractors during the above period of this contract.
                                            <div class="form-group {{ $errors->has('clause_a') ? 'has-error' : '' }}">
                                                <div class="col-md-12">
                                                    <div class="mt-radio-list">
                                                        <label class="mt-radio">
                                                            <input type="radio" name="clause_a" id="clause_a1" value="1" @if (old('clause_a') == 1) checked @endif> if true and comply with <b>(b)</b> to <b>(g)</b> below, as applicable. If it is not the case that workers or subcontractors are involved
                                                            or
                                                            you
                                                            are an exempt employer for workers compensation purposes
                                                            <span></span>
                                                        </label>
                                                        <label class="mt-radio">
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <label for="contractor_signed_name" class="col-md-2 control-label">f. &nbsp; Signature</label>
                                            <div class="col-md-6" style="display: none" id="contractor_signed_name_field">
                                                <x-form.textarea name="contractor_signed_name" value="" rows="3" readonly/>
                                    ...
                                    {{-- Position --}}
                                    <div class="row">
                                        <div class="form-group {{ $errors->has('contractor_signed_title') ? 'has-error' : '' }}">
                                            <label for="contractor_signed_name" class="col-md-2 control-label">g. &nbsp;Position/Title</label>
                                            <div class="col-md-9">
                                                <x-form.input name="contractor_signed_title" placeholder="Position/Title"/>
                                                <x-form.error name="contractor_signed_title"/>
                                            </div>
                                        </div>
                                    </div>
                                    <br>
